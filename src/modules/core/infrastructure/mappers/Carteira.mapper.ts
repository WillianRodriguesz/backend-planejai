...
export class CarteiraMapper {
  static ModelToDomain(model: CarteiraModel): Carteira {
    const lancamentos = LancamentoMapper.ModelToDomainList(model.lancamentos || []);
    const saldosMensais = SaldoMensalMapper.ModelToDomainList(model.saldosMensais || []);
  ...
  static DomainToModel(domain: Carteira): CarteiraModel {
    ...
    model.lancamentos = LancamentoMapper.DomainToModelList(domain.getLancamentos());
    model.saldosMensais = SaldoMensalMapper.DomainToModelList(domain.getSaldosMensais());
